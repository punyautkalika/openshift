...
# ------------------------------------------------------------------------
#
# This is a Dockerfile for the jboss-eap-7/eap73-openjdk8-openshift-rhel7:7.3.3 image.
...
# begin jboss.container.maven.35.bash:3.5scl
...
# end jboss.container.maven.35.bash:3.5scl
# begin eap-73-env:7.3.3

# Environment variables
ENV \
    JBOSS_EAP_VERSION="7.3.3" \
    JBOSS_HOME="/opt/eap" \
    JBOSS_PRODUCT="eap" \
    LAUNCH_JBOSS_IN_BACKGROUND="true" \
    PRODUCT_VERSION="7.3.3" \
    WILDFLY_VERSION="7.3.3.GA-redhat-00004" 
...
LABEL \
      ...
      org.jboss.product.eap.version="7.3.3"  \
      org.jboss.product.version="7.3.3" 

# Exposed ports
EXPOSE 8080
# end eap-73-env:7.3.3
...
ENV \
    ...
    GALLEON_VERSION="4.2.4.Final" \
    GALLEON_WILDFLY_VERSION="4.2.7.Final" \
...
# Install required RPMs and ensure that the packages were installed
USER root
RUN yum --setopt=tsflags=nodocs install -y diffutils \
    && rpm -q diffutils
...
# begin jboss.container.eap.galleon.config.ee:1.0

# Custom scripts
USER root
RUN [ "bash", "-x", "/tmp/scripts/jboss.container.eap.galleon.config.ee/configure.sh" ]

# end jboss.container.eap.galleon.config.ee:1.0
...
# begin os-eap-txnrecovery.run:python2
...
# end os-eap-txnrecovery.run:python2
...
# begin jboss-eap-7/eap73-openjdk8-openshift-rhel7:7.3.3

# Environment variables
ENV \
    HTTPS_ENABLE_HTTP2="true" \
    JBOSS_IMAGE_NAME="jboss-eap-7/eap73-openjdk8-openshift-rhel7" \
    JBOSS_IMAGE_VERSION="7.3.3" 

# Labels
LABEL \
      com.redhat.component="jboss-eap-7-eap73-openjdk8-openshift-container"  \
...
# Exposed ports
EXPOSE 8443
# end jboss-eap-7/eap73-openjdk8-openshift-rhel7:7.3.3
